...
The manifest automatically selects the complete ESP32-S3 or ESP32-C3 image set:
bootloader, partition table, boot application selector and CynusLink firmware.
